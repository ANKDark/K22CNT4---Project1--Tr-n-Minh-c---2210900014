...
<body class="dark">
    ...
    <div class="sidebar_tmd">
        ...
        <ul class="app_menu_tmd">
            ...
            <li><a class="app_menu_item_tmd active" href="quanly-khachhang-tmd.php"><i class='fa bx fa bx-id-card'></i><span
...
<script>
    function button_Delete_tmd(TENDN_TMD) {
        ...
        confirmButton.addEventListener('click', function () {
            ...
            xhr.open("POST", "xoa_khachhang_tmd.php", true);
    ...
    function gettendnData(tendnValue) {
        ...
        xhttp.open("POST", "sua_khachhang_tmd.php", true);
