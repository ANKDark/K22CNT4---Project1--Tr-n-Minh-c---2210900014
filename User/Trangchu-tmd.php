...
<body>
    ...
    <div class="banner_tmd">
        <div class="banner_item1_tmd">
            <button class="arrow-btn left" onclick="prevBanner()">❮</button>
            <button class="arrow-btn right" onclick="nextBanner()">❯</button>
            <div class="banner1_tmd">
                <h4>ANK Dark Laptop</h4>
                <h1>Laptop Gaming</h1>
                <p>Cùng với sự phát triển không ngừng của thế giới công nghệ, nhiều thương hiệu laptop hàng đầu đã liên
                    tục đưa ra đời những mẫu sản phẩm đa dạng về cấu hình, kiểu dáng, màu sắc và kích thước. Điều này
                    không chỉ đáp ứng nhu cầu ngày càng đa dạng của người tiêu dùng mà còn phản ánh xu hướng và phong
                    cách sống hiện đại.</p>
            </div>
        </div>
        <div class="banner_item2_tmd">
            <button class="arrow-btn left" onclick="prevBanner()">❮</button>
            <button class="arrow-btn right" onclick="nextBanner()">❯</button>
            <div class="banner2_tmd">
                <h4>ANK Dark Laptop</h4>
                <h1>Laptop Gaming</h1>
                <p>Cùng với sự phát triển không ngừng của thế giới công nghệ, nhiều thương hiệu laptop hàng đầu đã liên
                    tục đưa ra đời những mẫu sản phẩm đa dạng về cấu hình, kiểu dáng, màu sắc và kích thước. Điều này
        ...
        <div class="banner_item3_tmd">
            <button class="arrow-btn left" onclick="prevBanner()">❮</button>
            <button class="arrow-btn right" onclick="nextBanner()">❯</button>
            <div class="banner3_tmd">
                <h4>ANK Dark Laptop</h4>
                <h1>Laptop Gaming</h1>
                <p>Cùng với sự phát triển không ngừng của thế giới công nghệ, nhiều thương hiệu laptop hàng đầu đã liên
                    tục đưa ra đời những mẫu sản phẩm đa dạng về cấu hình, kiểu dáng, màu sắc và kích thước. Điều này
    ...
    <div id="menu_sp_tmd">
        <div class="sp_new_tmd">
            <button class="nut-sp-moi" onclick="btnspMoi()">
                <h2>Sản phẩm mới</h2>
            </button>
            ...
            <div class="list_items_new_tmd">
                ...
                <div class="list_item1_new_tmd" class="2nw">
                    ...
                    <div class="box-item">
                        <div class="them_gio_tmd">
                            <a href="#">
                                <p>Acer Nitro 5 AN515-58-56CH (Core i5 - 12500H, 16GB, 512GB, RTX 4050 6GB, 15.6 FHD IPS
                                    144Hz)</p>
                            </a>
                ...
                <div class="list_item1_new_tmd" class="3nw">
                    ...
                    <div class="box-item">
                        <div class="them_gio_tmd">
                            <a href="#">
                                <p>Acer Nitro 5 AN515-58-57QW (Core i5-12450H, 16GB, 512GB, RTX 3050Ti, 15.6 FHD IPS
                                    144Hz)</p>
                            </a>
                ...
                <div class="list_item1_new_tmd" class="4nw">
                    ...
                    <div class="box-item">
                        <div class="them_gio_tmd">
                            <a href="#">
                                <p>Lenovo Legion Y9000X IAH7 (Core i7-12700H, 16GB, 512GB, RTX 3060 6GB, 16'' QHD 165Hz)
                                </p>
                            </a>
        ...
        <button class="nut-sp-moi" class="nut-sp-pb" onclick="btnspPb()">
            <h2>Sản phẩm phổ biến</h2>
        </button>
        <button class="nut-sp-moi" class="nut-sp-km" onclick="btnspKm()">
            <h2>Sản phẩm khuyến mãi</h2>
        </button>
        <button class="nut-sp-moi" class="nut-sp-bc" onclick="btnspBc()">
        ...
        <div class="list_items_pb_tmd">
            ...
            <div class="list_sp_tmd">
                ...
                <div class="box-item">
                    <div class="them_gio_tmd">
                        <a href="#">
                            <p>Lenovo Legion Slim 5 Y7000P IRH8 (Core i7-13700H, 16GB, 1TB, RTX 4060 8GB, 16'' 2K+
                                165Hz)</p>
                        </a>
            ...
            <div class="list_sp_tmd">
                ...
                <div class="box-item">
                    <div class="them_gio_tmd">
                        <a href="#">
                            <p>Acer Predator Helios Neo 2023 PHN16-71-50JG (Core i5-13500HX, 16GB, 512GB, RTX 4050 6GB,
                                16 FHD+ 165Hz)</p>
                        </a>
                        <span class="money">22.890.000</span><br>
                        <button class="them_gio_btn_tmd" name="add_gio_tmd" type="button">Xem chi tiết</button>
            ...
            <div class="list_sp_tmd">
                ...
                <div class="box-item">
                    <div class="them_gio_tmd">
                        <a href="#">
                            <p>Dell Gaming G15 5525 (Ryzen 7-6800H, 16GB, 512GB, NVIDIA RTX 3050Ti 4GB, 15.6'' FHD
                                120Hz)</p>
                        </a>
        ...
        <div class="list_items_km_tmd">
            ...
            <div class="list_sp_tmd">
                ...
                <div class="box-item">
                    <div class="them_gio_tmd">
                        <a href="#">
                            <p>Acer Predator Helios Neo 2023 PHN16-71-73LT (Core i7-13700HX, 16GB, 1TB, RTX 4060 8GB, 16
                                WQXGA 165Hz)</p>
                        </a>
            ...
            <div class="list_sp_tmd">
                ...
                <div class="box-item">
                    <div class="them_gio_tmd">
                        <a href="#">
                            <p>Acer Nitro 5 AN515-55-50V2 (Core i5-10300H, 16GB, 512GB, GTX1650Ti 4GB DDR6, 15.6' FHD
                                144Hz)</p>
                        </a>
            ...
            <div class="list_sp_tmd">
                ...
                <div class="box-item">
                    <div class="them_gio_tmd">
                        <a href="#">
                            <p>Asus ROG Strix G15 2022 G513RC (Ryzen 7-6800HS, 8GB, 512GB, RTX 3050, 15.6'' FHD 144Hz)
                            </p>
                        </a>
